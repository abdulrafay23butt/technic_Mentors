...
mongoose.connect("mongodb+srv://abdulrafay23butt:9pGejBEZUzzyCQ0H@temp.vsrl7.mongodb.net/?retryWrites=true&w=majority&appName=temp")
    .then(() => {
        console.log("db connected");
    });

// mongoose.connect("mongodb+srv://abdulrafay23butt:PASS1962706@pgc@temp.vsrl7.mongodb.net/?retryWrites=true&w=majority&appName=temp")
//     .then(() => {
//         console.log("db connected");
//     })
